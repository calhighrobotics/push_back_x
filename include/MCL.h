...
namespace MCLConfig {
  ...
  static constexpr double ADAPTIVE_ALPHA = 0.3; 
  static constexpr double SIGMA_MIN = 1.0; 
  static constexpr double SIGMA_MAX = 3.0;
...
class MCLDistanceSensor {
  ...
  void Measure(void) {
    ...
    double dist = this->Sensor.get_distance() * 0.0393701;
...
namespace MCL {
  ...
  static constexpr int num_particles = 1300;
