...
const SensorConfig front_sensor_cfg = {0, -5.25, 0};   
const SensorConfig left_sensor_cfg  = {-2.5, -5.25, 90};   
const SensorConfig right_sensor_cfg = {-2.25, 5.25, -90};  
...
void distanceReset(bool setPose = true) {
